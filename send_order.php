...
if (isset($_POST["submit"])) {
  ...
  updateSend($_POST["orders_id"], $_POST["tracking_number"], $_POST["status"]);
}
?>
              ...
              <div class="box-checkout">
                ...
                <div class="billing-fields">
                  ...
                  <div class="fields-content">
                    ...
                    <div class="field-row">
                      <label for="company-name">หมายเลขการจัดส่ง</label>
                      <input type="text" name="tracking_number" value="<?php echo $currentOrders["tracking_number"]; ?>">
                    </div>
                    <div class="field-row">
