...
$(document).ready(function () {
  ...
  $.get(url, function (data) {
      ...
      if (data[index].id == pid) {
        show +=
            '<div class="span8">' +
                ...
                '<p style="font-size: 15px;"><b style="font-size: 17px;">ที่อยู่ในการจัดส่ง : </b>' + data[index].address  + '</p>' +
                ...
                '<p style="font-size: 17px;"><b style="font-size: 21px;">วันที่จะได้รับสินค้า : </b>' + data[index].DateOfReceiving  + '<b style="font-size: 17px;"></b></p>' +
    ...
    document.getElementById("productStatusDT").innerHTML = show;
  });
});
